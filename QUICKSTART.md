...
1. **Get the kit.** Clone the repo or download the ZIP (Code → Download ZIP) and unzip it.
2. **Open the folder as a Cowork Project** (open the `gtm-tech-week-london` folder in Cowork).
